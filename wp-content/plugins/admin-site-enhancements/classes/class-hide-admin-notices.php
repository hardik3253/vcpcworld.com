    ...
    public function admin_notices_menu_inline_css() {
        ...
        if ( is_admin() && !is_customize_preview() && current_user_can( $minimum_capability ) ) {
            ...
            <style type="text/css">
                ...
                #wpbody-content > .wrap > div:not(#loco-notices,#loco-content) > .notice:not(.system-notice,.hidden,#asenha-fm-warning-notice,#asenha-smtp-password-notice,#asenha-wpml-stale-job-notice,#asenha-view-admin-as-role-recovery-notice,[data-id=clone_resolution_options_notice],[data-id=temporary_duplicate_notice]),
                ...
                #wpbody-content > .wrap > div:not(#loco-notices,#loco-content) > .notice-warning:not(.hidden,#asenha-fm-warning-notice,#asenha-smtp-password-notice,#asenha-wpml-stale-job-notice,#asenha-view-admin-as-role-recovery-notice,[data-id=clone_resolution_options_notice],[data-id=temporary_duplicate_notice]),
                ...
                #wpbody-content > .notice:not(.otgs-notice,.wcml-notice,#asenha-smtp-password-notice,#asenha-wpml-stale-job-notice,#asenha-view-admin-as-role-recovery-notice,[data-id=clone_resolution_options_notice],[data-id=temporary_duplicate_notice]),
                #wpbody-content > .error,
