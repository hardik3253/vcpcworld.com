...
$eyebrow    = vcpc_field( 'angelo_seminara_eyebrow', '' );
$heading    = vcpc_field( 'angelo_seminara_heading', '' );
$content    = vcpc_field( 'angelo_seminara_content', '' );
$media_id   = vcpc_field( 'angelo_seminara_media', 0 );
